    ...
    async with AsyncSessionFactory() as session:
        ...
        for u in users:
            ...
            users_data.append({
                ...
                "total_contribution_distance_km": float(u.total_contribution_distance_km or 0),
                "reward_points_balance": u.reward_points_balance,
                "reward_points_reserved": u.reward_points_reserved,
                "reward_points_lifetime": u.reward_points_lifetime,
                "reward_points_redeemed": u.reward_points_redeemed,
...
async def get_user_detail(user_id: str):
    ...
    async with AsyncSessionFactory() as session:
        ...
        return {
            ...
            "total_contribution_distance_km": float(user.total_contribution_distance_km or 0),
            "reward_points_balance": user.reward_points_balance,
            "reward_points_reserved": user.reward_points_reserved,
            "reward_points_lifetime": user.reward_points_lifetime,
            "reward_points_redeemed": user.reward_points_redeemed,
